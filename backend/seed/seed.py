...
HOME_PAGE_AR = {
    ...
    'meta_description': 'اطلب بوكس 5G من توبنيت Huawei H153-381 : تركيب Plug & Play، Wi-Fi 6، سرعات تصل إلى 100 ميجابت/ثانية. شبكة هجينة 5G + 4G.',
    'hero': {
        'enabled': True,
        'slides': [
            {
                ...
                'text': 'بوكس 5G من توبنيت Huawei H153-381 : بدون فنّي، بدون كابل. أوصله واتصل واستمتع بسرعة فائقة تصل إلى 100 ميجابت/ثانية.',
    ...
    'about': {
        ...
        'text': 'بوكس 5G من توبنيت Huawei H153-381 يحوّل الشبكة المتنقلة إلى إنترنت منزلي. أدخل شريحة SIM TOPNET 5G، اربط أجهزتك عبر Wi-Fi 6 واستمتع بسرعة تحميل تصل إلى 100 ميجابت/ثانية.',
        'features': [
    ...
    'steps': {
        ...
        'helpText': 'اتصل على 1120 — متاح 7/7، أو زر أقرب وكالة توبنيت.',
    },
    'faq': {
        'enabled': True,
        ...
        'items': [
            {'question': 'ما هو بوكس 5G توبنيت؟', 'answer': 'بوكس 5G توبنيت (Huawei H153-381) هو حل إنترنت فائق السرعة يعتمد على شبكة 5G دون الحاجة لخط هاتف ثابت أو ألياف. يتم توصيله بالكهرباء مباشرة.'},
            ...
            {'question': 'كيف أعرف هل منطقتي مغطاة؟', 'answer': 'يتحقق المستشار من التغطية عبر أداة المحاكاة الخاصة بتوبنيت أو في الوكالة.'},
    ...
    'news': {
        ...
        'items': [
            ...
            {'title': 'اعتماد بوكس Huawei H153-381 لعروض 5G توبنيت', 'excerpt': 'اكتشف الراوتر الثابت فائق الأداء مع Wi-Fi مدمج وتركيب Plug & Play.', 'date': '28 فيفري 2026', 'link': '#'},
    ...
    'cta': {
        ...
        'subtitle': 'اطلب عبر الإنترنت الآن أو توجه إلى أقرب وكالة توبنيت.',
