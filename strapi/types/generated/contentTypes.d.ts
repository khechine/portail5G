...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Toutes les sections de la landing page. Chaque section peut \u00EAtre activ\u00E9e / d\u00E9sactiv\u00E9e.';
    displayName: "Page d'accueil (Box 5G)";
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Les commandes Box 5G envoy\u00E9es depuis le site.';
    displayName: 'Demandes de commande';
    pluralName: 'leads';
    singularName: 'lead';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    existingSubscriber: Schema.Attribute.String;
    firstname: Schema.Attribute.String;
    governorate: Schema.Attribute.String;
    lastname: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Identit\u00E9, couleurs, polices, topbar, navigation, footer.';
    displayName: 'Configuration du site';
  ...
  attributes: {
    ...
    arabicFont: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Cairo'>;
    ...
    lightBg: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'#F7F5F1'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
